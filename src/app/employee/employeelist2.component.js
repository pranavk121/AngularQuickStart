...
var EmployeeList2Component = (function () {
    ...
    EmployeeList2Component.prototype.getEmployeeList = function () {
        this.employees = [
            {
                code: 'emp101', name: 'Tom', gender: 'Male',
                annualSalary: 5500, dateOfBirth: '6/25/1988'
    ...
    EmployeeList2Component.prototype.trackByEmpCode = function (index, employee) {
